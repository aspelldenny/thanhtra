...
```bash
git clone --branch v1.3.1 --depth 1 https://github.com/aspelldenny/thanhtra ~/thanhtra   # pin theo tag release (xem SECURITY.md)
cd ~/thanhtra
...
git diff v1.3.0..v1.3.1 -- skills/ SECURITY.md   # review những gì sẽ chạy trong agent của bạn
git checkout v1.3.1
```
