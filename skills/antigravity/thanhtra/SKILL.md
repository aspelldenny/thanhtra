...
- **Explicit slash command:** nếu workspace có file `.agent/workflows/thanhtra.md` (xem README để biết cách tạo), gõ `/thanhtra` để invoke.
...
```
┌─────────────────────────────────────────────────────────────────────┐
│         Thanh Tra SCAN WORKFLOW (Antigravity — Sequential)               │
├─────────────────────────────────────────────────────────────────────┤
...
**Save-to-file:** ghi TOÀN BỘ report (identical với stdout) vào `thanhtra-reports/scan-<timestamp>.md` dùng tool write của Antigravity.
