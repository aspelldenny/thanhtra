...
### Step L2 — Load pre-scan evidence
...
### Step L5 — Process chunks SEQUENTIALLY
...
3. **Apply rules cho files trong chunk:**
   ...
   - Bắt đầu từ hot spots trong `.thanhtra-pre-scan.json` thuộc chunk này, rồi mới rà phần còn lại.
...
So sánh: Claude variant parallel ~2-10 min cho cùng workload. Sequential variant chậm hơn ~3× nhưng output identical. Chấp nhận trade-off để giữ portability.
