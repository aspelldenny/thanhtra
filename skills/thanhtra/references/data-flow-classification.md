...
Phân loại nguồn dữ liệu để quyết định 1 pattern code có thực sự là vulnerability hay không. **Đây là phương pháp luận cốt lõi của Thanh Tra** — phân biệt giữa pattern-match thuần và phân tích bảo mật thực thụ.
...
Đây là lý do tại sao Thanh Tra phải READ context, không chỉ grep. Pattern-match thuần sẽ vừa miss thật vừa fp ầm ầm.
