...
These rule files override generic rules when Thanh Tra detects primary language as `python`.

## Language detection scope

Thanh Tra treats these as `python`:
- `.py` (Python source)
...
2. Run `/thanhtra all` on the repo
3. Verify: did Thanh Tra catch real issues? Did it flag any false positives?
