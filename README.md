...
```bash
git clone --branch v1.4.1 --depth 1 https://github.com/aspelldenny/thanhtra ~/thanhtra   # pin a release tag (see SECURITY.md)
cd ~/thanhtra
...
git diff v1.4.0..v1.4.1 -- skills/ SECURITY.md   # review what will run in your agent
git checkout v1.4.1
```
